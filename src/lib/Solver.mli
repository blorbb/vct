...
module Spec :
 sig
  ...
  type tableau_jumps_graph = Spec.tableau_jumps_graph =
  ...
  and tableau_jumps_clause_2_graph = Spec.tableau_jumps_clause_2_graph =
  ...
  and tableau_jumps_clause_2_clause_2_graph = Spec.tableau_jumps_clause_2_clause_2_graph =
  ...
  and tableau_jumps_clause_2_clause_2_clause_2_graph = Spec.tableau_jumps_clause_2_clause_2_clause_2_graph =
  ...
  type tableau_graph = Spec.tableau_graph =
  | Coq_tableau_graph_refinement_1 of Assumptions.t * CplSolver.t * Mchain.t
     * tableau_clause_1_graph
  and tableau_clause_1_graph = Spec.tableau_clause_1_graph =
  ...
  and tableau_clause_1_clause_2_graph = Spec.tableau_clause_1_clause_2_graph =
  ...
  and tableau_clause_1_clause_2_clause_2_graph = Spec.tableau_clause_1_clause_2_clause_2_graph =
...
module TailRec :
 sig
  ...
  module JumpSolution :
   sig
    type t = Search.Spec.JumpSolution.t =
    | Sat of Tree.t list
    | Unsat of DiaClause.t * Assumptions.t * Derivation.t
  ...
  type tableau_jumps_graph = TailRec.tableau_jumps_graph =
  | Coq_tableau_jumps_graph_equation_1 of t * CplClause.t list
  ...
  and tableau_jumps_clause_2_graph = TailRec.tableau_jumps_clause_2_graph =
  ...
  type tableau_graph = TailRec.tableau_graph =
  | Coq_tableau_graph_refinement_1 of Assumptions.t * CplSolver.t * Mchain.t
     * tableau_clause_1_graph
  and tableau_clause_1_graph = TailRec.tableau_clause_1_graph =
  | Coq_tableau_clause_1_graph_refinement_1 of Assumptions.t * CplSolver.t
     * t * Mchain.t * tableau_clause_1_clause_2_graph
  | Coq_tableau_clause_1_graph_equation_2 of Assumptions.t * CplSolver.t
     * Assumptions.t * Mchain.t
  and tableau_clause_1_clause_2_graph = TailRec.tableau_clause_1_clause_2_graph =
  | Coq_tableau_clause_1_clause_2_graph_equation_1 of Assumptions.t
     * CplSolver.t * t * Mchain.t
  | Coq_tableau_clause_1_clause_2_graph_refinement_2 of Assumptions.t
     * CplSolver.t * t * Mchain.t * Lclauses.t * Lclauses.t list
     * (Assumptions.t -> tableau_graph)
     * tableau_clause_1_clause_2_clause_2_graph
  and tableau_clause_1_clause_2_clause_2_graph = TailRec.tableau_clause_1_clause_2_clause_2_graph =
  | Coq_tableau_clause_1_clause_2_clause_2_graph_equation_1 of Assumptions.t
     * CplSolver.t * t * Mchain.t * Lclauses.t * Lclauses.t list * Tree.t list
  | Coq_tableau_clause_1_clause_2_clause_2_graph_equation_2 of Assumptions.t
     * CplSolver.t * t * Mchain.t * Lclauses.t * Lclauses.t list * int
...
module NoModel :
 sig
  ...
  type tableau_jumps_graph = NoModel.tableau_jumps_graph =
  | Coq_tableau_jumps_graph_equation_1 of t * CplClause.t list
     * BoxClause.t list * Mchain.t * (Assumptions.t -> Solution.t)
  | Coq_tableau_jumps_graph_refinement_2 of t * CplClause.t list
     * BoxClause.t list * int * Lit.t * DiaClause.t list * Mchain.t
     * (Assumptions.t -> Solution.t) * tableau_jumps_clause_2_graph
  and tableau_jumps_clause_2_graph = NoModel.tableau_jumps_clause_2_graph =
  | Coq_tableau_jumps_clause_2_graph_refinement_1 of t * CplClause.t list
     * BoxClause.t list * int * Lit.t * DiaClause.t list * Mchain.t
     * (Assumptions.t -> Solution.t) * tableau_jumps_clause_2_clause_2_graph
  | Coq_tableau_jumps_clause_2_graph_equation_2 of t * CplClause.t list
     * BoxClause.t list * int * Lit.t * DiaClause.t list * Mchain.t
     * (Assumptions.t -> Solution.t) * tableau_jumps_graph
  and tableau_jumps_clause_2_clause_2_graph = NoModel.tableau_jumps_clause_2_clause_2_graph =
  ...
  type tableau_graph = NoModel.tableau_graph =
  | Coq_tableau_graph_refinement_1 of Assumptions.t * CplSolver.t * Mchain.t
     * tableau_clause_1_graph
  and tableau_clause_1_graph = NoModel.tableau_clause_1_graph =
  | Coq_tableau_clause_1_graph_refinement_1 of Assumptions.t * CplSolver.t
     * t * Mchain.t * tableau_clause_1_clause_2_graph
  | Coq_tableau_clause_1_graph_equation_2 of Assumptions.t * CplSolver.t
     * Assumptions.t * Mchain.t
  and tableau_clause_1_clause_2_graph = NoModel.tableau_clause_1_clause_2_graph =
  | Coq_tableau_clause_1_clause_2_graph_equation_1 of Assumptions.t
     * CplSolver.t * t * Mchain.t
  | Coq_tableau_clause_1_clause_2_graph_refinement_2 of Assumptions.t
     * CplSolver.t * t * Mchain.t * Lclauses.t * Lclauses.t list
     * (Assumptions.t -> tableau_graph)
     * tableau_clause_1_clause_2_clause_2_graph
  and tableau_clause_1_clause_2_clause_2_graph = NoModel.tableau_clause_1_clause_2_clause_2_graph =
  | Coq_tableau_clause_1_clause_2_clause_2_graph_equation_1 of Assumptions.t
     * CplSolver.t * t * Mchain.t * Lclauses.t * Lclauses.t list
  | Coq_tableau_clause_1_clause_2_clause_2_graph_equation_2 of Assumptions.t
     * CplSolver.t * t * Mchain.t * Lclauses.t * Lclauses.t list * int
